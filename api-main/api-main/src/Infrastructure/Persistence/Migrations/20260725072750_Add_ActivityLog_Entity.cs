...
{
    /// <inheritdoc />
    public partial class Add_ActivityLog_Entity : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserRoles = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false),
                    TargetEntityType = table.Column<byte>(type: "smallint", nullable: false),
