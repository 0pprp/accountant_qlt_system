...
mixin _$File {
  ...
  int get fileSizeInByte => throw _privateConstructorUsedError;
  ...
  $Res call({
    ...
    return _then(
      _value.copyWith(
            ...
            fileSizeInByte:
                null == fileSizeInByte
                    ? _value.fileSizeInByte
                    : fileSizeInByte // ignore: cast_nullable_to_non_nullable
                        as int,
            type:
                null == type
                    ? _value.type
...
class _$FileImpl implements _File {
  ...
  @override
  String toString() {
    return 'File(id: $id, originalFileName: $originalFileName, relativePath: $relativePath, fileSizeInByte: $fileSizeInByte, type: $type)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.fileSizeInByte, fileSizeInByte) ||
...
abstract class _File implements File {
  const factory _File({
    ...
    required final int fileSizeInByte,
