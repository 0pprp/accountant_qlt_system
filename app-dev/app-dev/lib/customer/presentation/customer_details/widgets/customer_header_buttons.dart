...
class CustomerHeaderButtons extends StatelessWidget {
  const CustomerHeaderButtons({super.key});

  @override
  Widget build(BuildContext context) {
    final bloc = context.read<CustomerDetailsBloc>();
    return Row(
      children: [
        // Expanded(
        //   child: FilledButton(
        ...
        //         () =>
        //             bloc.user?.id != null
        //                 ? Navigator.pushNamed(context, RouteNames.customerSales, arguments: {'userId': bloc.user?.id})
        //                 : null,
